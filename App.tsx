...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative selection:bg-purple-600 selection:text-white overflow-x-hidden bg-[#f8f6ff]">
      {/* Dynamic Background */}
      ...
      <footer className="py-32 relative bg-slate-950/98 backdrop-blur-3xl overflow-hidden border-t border-slate-900">
        ...
        <div className="max-w-[1440px] mx-auto px-16 relative z-10 flex flex-col md:flex-row justify-between items-center gap-20">
          <div className="flex flex-col items-center md:items-start gap-12">
             ...
             <div className="flex gap-12 items-center">
                <a href={LINKEDIN_URL} target="_blank" className="text-slate-500 hover:text-white transition-all transform hover:scale-125">
                ...
                <a href={`https://github.com/${GITHUB_USERNAME}`} target="_blank" className="text-slate-500 hover:text-white transition-all transform hover:scale-125">
                ...
                <a href={INSTAGRAM_URL} target="_blank" className="text-slate-500 hover:text-white transition-all transform hover:scale-125">
                ...
                <a href={X_URL} target="_blank" className="text-slate-500 hover:text-white transition-all transform hover:scale-125">
          ...
          <div className="flex flex-col items-center md:items-end gap-12">
             <button onClick={() => window.open(RESUME_URL, '_blank')} className="text-[14px] font-black text-white uppercase tracking-[0.5em] bg-white text-slate-950 hover:bg-slate-100 px-12 py-5 rounded-3xl border border-slate-800 shadow-3xl transition-all">Download Portfolio</button>
             <div className="text-center md:text-right space-y-4">
                <p className="text-[12px] font-black text-slate-600 uppercase tracking-[2em]">Built with Passion & Swiss Precision</p>
                <p className="text-[10px] font-bold text-slate-800 uppercase tracking-[1em]">Secure Node 22U // 2025</p>
             </div>
          </div>
        </div>
      </footer>
