  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        initial="hidden"
        animate="visible"
        className="relative pt-12 pb-16 lg:pb-24 overflow-hidden"
      >
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-20 flex flex-col items-center text-center">
          ...
          <motion.div variants={fadeUp} className="text-xl md:text-2xl lg:text-3xl font-heading font-semibold leading-snug max-w-3xl mb-4 w-full">
            <RotatingRole />
          ...
          {/* CTA buttons */}
          <motion.div variants={fadeUp} className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg mb-12">
            <a
              href={LINKEDIN_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl bg-t-accent text-white text-[10px] font-mono font-bold uppercase tracking-[0.2em] shadow-xl shadow-t-accent/20 hover:shadow-2xl hover:shadow-t-accent/30 hover:scale-[1.03] transition-all duration-300"
            >
              <span>LinkedIn</span>
            ...
            <button
              ...
              className="group flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl border-2 border-t-border/40 text-t-fg text-[10px] font-mono font-bold uppercase tracking-[0.2em] hover:border-t-accent/50 hover:text-t-accent hover:bg-t-accent/5 hover:scale-[1.03] transition-all duration-300"
            >
            ...
            <button
              ...
              className="group flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl bg-t-bg-el/60 backdrop-blur-xl border border-t-border/40 text-t-fg text-[10px] font-mono font-bold uppercase tracking-[0.2em] hover:scale-[1.03] transition-all duration-300 shadow-xl"
            >
            ...
            <a
              ...
              className="group flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-[10px] font-mono font-bold uppercase tracking-[0.2em] hover:bg-emerald-500/20 hover:scale-[1.03] transition-all duration-300"
            >
          ...
          <div className="w-full flex flex-col items-center">
            {/* Metrics row */}
            <motion.div variants={stagger} className="flex flex-wrap items-center justify-center gap-4 mb-8">
        ...
        {/* Badge preview marquee */}
        <motion.div
          variants={stagger}
          className="w-full mt-24 bg-t-fg/[0.02] dark:bg-white/[0.02] border-y border-t-border/10"
        >
          <div className="max-w-7xl auto px-4 md:px-8 text-center pt-8">
            <span className="text-[9px] font-mono font-bold uppercase tracking-[0.35em] text-t-accent mb-1 inline-block">
