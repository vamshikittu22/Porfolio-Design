...
export const AboutHeader: React.FC = () => {
    return (
        <div className="flex flex-col gap-6 mb-16 px-4 lg:px-0">
            ...
            <h2 className="text-[clamp(3rem,8vw,7rem)] font-black font-display text-t-fg uppercase tracking-tighter leading-[0.85]">
                Executive <br /> <span className="text-t-fg-m opacity-40">Profile.</span>
            </h2>
            <div className="space-y-8 border-l-4 border-t-accent/20 pl-6 md:pl-10 py-4 max-w-[min(900px,100%)]">
                <p className="text-[clamp(1.1rem,2vw,1.5rem)] text-t-fg font-medium leading-relaxed italic">
                ...
                <p className="text-[clamp(0.9rem,1.1vw,1.1rem)] text-t-fg-m leading-relaxed opacity-90">
                    I specialize in Java/Spring Boot microservices and modern frontend architectures using Angular, React, and Vue.js. Currently at CVS Health, I engineer REST and GraphQL APIs for claims processing workflows while integrating AI-assisted analytics using OpenAI APIs. My experience spans from digital banking modernization at Mphasis to enterprise healthcare systems, with a focus on cloud-native deployments, event-driven architectures, and secure authentication using OAuth 2.0 and JWT.
                </p>
                <p className="text-[clamp(0.9rem,1.1vw,1.1rem)] text-t-fg-m leading-relaxed opacity-90">
