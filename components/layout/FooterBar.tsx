            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="w-11 h-11 rounded-full border border-t-border bg-t-bg/40 flex items-center justify-center text-t-fg transition-all duration-200 hover:text-t-accent-2 hover:scale-110 active:scale-95 shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-t-accent"
                  title={link.label}
                >
