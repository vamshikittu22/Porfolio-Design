        ...
        <div className="flex flex-col gap-6 mb-16 px-4 lg:px-0">
            ...
            <div className="space-y-8 border-l-4 border-t-accent/20 pl-10 py-4 max-w-4xl">
              <p className="text-xl lg:text-2xl text-t-fg font-medium leading-relaxed italic">
                "Full Stack Developer with 5+ years of experience building scalable, secure enterprise applications across healthcare, finance, and banking domains."
              </p>
              <p className="text-base lg:text-lg text-t-fg-m leading-relaxed opacity-90">
                I specialize in Java/Spring Boot microservices and modern frontend architectures (Angular/React). From optimizing low-latency trading systems at Citadel to architecting claims processing dashboards at CVS Health, my work prioritizes HIPAA/Compliance-ready security, Kafka-based real-time streaming, and AWS cloud-native deployments.
              </p>
            </div>
        </div>
