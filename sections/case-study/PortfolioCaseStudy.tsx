        ...
        <section className="space-y-16 mb-32">
          <div className="space-y-8">
            <div className="flex items-center gap-6">
              ...
              <span className="text-[11px] font-black uppercase tracking-[1em] text-t-accent">Architecture Specification</span>
            </div>
            ...
            <p className="text-xl lg:text-3xl text-t-fg-m font-medium leading-tight tracking-tight max-w-4xl">
              This portfolio is a full-stack, <span className="text-t-accent font-black">AI-Native Application</span> designed to demonstrate production-grade architecture and performance optimization.
            </p>
          </div>
        </section>
