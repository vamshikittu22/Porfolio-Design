  ...
  return (
    <section id="resume-section" className="mb-[15rem] lg:mb-[20rem] scroll-mt-32">
      <ScrollReveal className="max-w-7xl mx-auto px-6 lg:px-20">
        ...
        >
          {/* 
            EXECUTIVE PRINT ENGINE v5.0
            - Optimized for 2-page professional output
            - Uses Times New Roman/Arial stack for HR compliance
          */}
          <style>{`
            @media print {
              ...
              .print-doc { color: black !important; font-family: "Times New Roman", serif !important; line-height: 1.2 !important; }
              .print-hide { display: none !important; }
              .section-hdr {
                font-family: Arial, sans-serif !important; font-size: 11pt !important; font-weight: 800 !important;
                text-transform: uppercase !important; border-bottom: 1pt solid #000 !important;
                margin-top: 12pt !important; margin-bottom: 6pt !important; padding-bottom: 1pt !important;
              }
              .item-hdr { font-family: Arial, sans-serif !important; font-size: 10.5pt !important; font-weight: 700 !important; }
              .txt-body { font-size: 9.5pt !important; color: black !important; }
              .bullet { margin-bottom: 2pt !important; }
          ...
          <div className="print-doc">
            <header className="flex flex-col items-center mb-8 text-center print:mb-4">
              ...
              <div className="text-sm font-bold text-t-fg print:text-[11pt] print:font-bold uppercase tracking-widest">
                {RESUME_CONTENT.role} | {RESUME_CONTENT.contact.location}
              </div>
              <div className="mt-4 text-xs lg:text-sm font-medium text-t-fg-m print:text-black print:text-[9.5pt] print:mt-1 font-mono flex flex-wrap justify-center gap-4">
              ...
              <div className="mt-10 flex gap-4 print-hide">
                <GlassButton primary accent="theme" onClick={handleDownload} className="!px-8 !py-4 !text-[10px]">
                  Download Official PDF
                </GlassButton>
                <GlassButton accent="theme" onClick={handlePrint} className="!px-8 !py-4 !text-[10px]">
                  Print Snapshot
                </GlassButton>
              </div>
            </header>
            ...
            <div className="space-y-8 print:space-y-1">
              ...
              <section className="break-avoid">
                ...
                <div className="grid grid-cols-1 gap-1 print:txt-body">
                  ...
                  <p><strong>Cloud:</strong> {RESUME_CONTENT.technicalSkills.cloud.join(', ')}</p>
                  <p><strong>DevOps:</strong> {RESUME_CONTENT.technicalSkills.devops.join(', ')}</p>
                ...
                <div className="space-y-8 print:space-y-4">
                  {RESUME_CONTENT.experience.map((exp, idx) => (
                    <div key={idx} className="break-avoid">
                      ...
                      <ul className="space-y-1.5 print:list-disc print:ml-5">
              ...
              <section>
                <h3 className="text-sm font-black tracking-[0.2em] text-t-fg uppercase mb-4 print:section-hdr">Technical Projects</h3>
                <div className="space-y-6 print:space-y-4">
                  {RESUME_CONTENT.projects.map((proj, idx) => (
                    <div key={idx} className="break-avoid">
                      ...
                      <p className="text-[10px] font-black uppercase text-t-accent-2 mb-2 print:text-[8.5pt] print:mb-1">{proj.subtitle}</p>
              ...
              <footer className="pt-16 border-t border-t-border print-hide">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
                  <p className="text-[10px] font-black text-t-fg-m font-mono uppercase tracking-[0.4em] opacity-40">
                    Document Ref: VKP-2025-ARCH-v5
                  </p>
                  <div className="flex gap-4">
                    <GlassButton accent="theme" onClick={handleDownload}>Download CV</GlassButton>
